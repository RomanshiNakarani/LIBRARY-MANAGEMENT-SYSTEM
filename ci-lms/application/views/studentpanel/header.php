...
<!-- Sidebar/menu -->
    ...
    scroll-behavior: smooth;" id="mySidebar"><br>
      ...
      <div class="w3-bar-block">
        <a href="<?= site_url('studentpanel/index')?>" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-red">HOME</a> 
        <a href="<?= site_url('studentpanel/book')?>" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-red">BOOKS</a> 
        <a href="<?= site_url('admin/')?>" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-red">My BOOKS</a> 
        <a href="<?= site_url('users/login')?>" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-red">LOGOUT</a> 
